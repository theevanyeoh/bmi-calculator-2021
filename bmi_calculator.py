...
def get_height():
    '''
       This function gets height value, yk to see how tall that person is
    '''
...
def get_weight():
    '''
       This function gets weight value, yk to see how much that person weighs
    '''
    weight = float(ENTRY1.get())
    return weight


def calculate_bmi(a=""):   # "a" is there because the bind function gives an argument to the function... arguments lol
    print(a)
    '''
      This function calculates the result, gotta need the results
    '''
    try:
        height = get_height()
        weight = get_weight()
        ...
        messagebox.showinfo("Result", "Please enter valid data you asshole!")
    else:
        if bmi <= 15.0:
            res = "Your BMI is " + str(bmi) + "\nRemarks: Very severely FUCKING UNDERWEIGHT!!! EAT MORE PLEASE I SWEAR"
            ...
            res = "Your BMI is " + str(bmi) + "\nRemarks: Damn, bro. I have no idea what to say at this point"
            messagebox.showinfo("Result", res)
